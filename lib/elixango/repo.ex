  ...
  defmacro __using__(opts) do
    quote do
      ...
      def insert(struct, opts \\ []) do
        Elixango.Ecto.Repo.Schema.insert(@otp_app, get_dynamic_repo(), struct, with_default_options(:insert, opts))
      end

      def update(struct, opts \\ []) do
        Elixango.Ecto.Repo.Schema.update(@otp_app, get_dynamic_repo(), struct, with_default_options(:update, opts))
      end
      ...
      def delete(struct, opts \\ []) do
        Elixango.Ecto.Repo.Schema.delete(@otp_app, get_dynamic_repo(), struct, with_default_options(:delete, opts))
      end
      ...
      def insert_all(schema_or_source, entries, opts \\ []) do
        Elixango.Ecto.Repo.Schema.insert_all(@otp_app, get_dynamic_repo(), schema_or_source, entries, with_default_options(:insert_all, opts))
      end
              ...
              Enum.reduce(stream, [],
                fn resp, acc ->
                  acc ++ Enum.reduce(to_struct_all(struct_, resp.body["result"]), [],
                    fn(data, acc) ->
                       [Elixango.Ecto.Repo.Schema.load(Elixango.Ecto.Adapter, struct_.__struct__.__struct__, Map.to_list(data)) | acc]
                    end)
                end) |> Enum.reverse
            end,
            write: @collections
      ...
      def get(struct_, id, _opts \\ []) do
        case Arangox.get(__MODULE__, "/_api/document/#{collection(struct_)}/#{id}") do
          {:ok, _, %{body: body}} ->
            ...
            {:ok, Elixango.Ecto.Repo.Schema.load(Elixango.Ecto.Adapter,
             struct_.__struct__.__struct__,
      ...
      def get!(struct_, id, _opts \\ []) do
        case Arangox.get!(__MODULE__, "/_api/document/#{collection(struct_)}/#{id}") do
          %{body: body} ->
            ...
            Elixango.Ecto.Repo.Schema.load(Elixango.Ecto.Adapter,
             struct_.__struct__.__struct__,
              Map.to_list(to_struct(struct_, body))
            )
        end
      ...
      def prepare_changeset_for_insert(changeset, opts \\ []) do
        Elixango.Ecto.Repo.Schema.prepare_changeset_for_insert(@otp_app, changeset, opts)
      end

      def prepare_changeset_for_update(changeset, opts \\ []) do
        Elixango.Ecto.Repo.Schema.prepare_changeset_for_update(@otp_app, changeset, opts)
      end

      def prepare_changeset_keep_virtual(changeset, opts \\ []) do
        Elixango.Ecto.Repo.Schema.prepare_changeset_keep_virtual(@otp_app, changeset, opts)
      end
      ...
      #   case Elixango.Ecto.Type.adapter_dump(adapter, type, value) do
      #     {:ok, value} ->
      #       value
      #     :error ->
      ...
      #   case Elixango.Ecto.Type.adapter_load(adapter, type, value) do
      #     {:ok, value} ->
      ...
      #         {:ok, load_changes(changeset, :loaded, return_types, to_struct(struct_, body["new"]), embeds, autogen, Elixango.Ecto.Adapter, schema_meta)}
      #
      #       {:error, %{status: status}} -> {:error, handle_status(status)}
      #     end
      #   else
      ...
      def one(struct_, query_string) do
        ...
        case res do
          ...
          {:error, _} = err -> err
          _ ->
            Elixango.Ecto.Repo.Schema.load(
              Elixango.Ecto.Adapter,
              struct_.__struct__.__struct__,
