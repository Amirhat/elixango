defmodule Elixango.Ecto.Type.Custom do
  defmacro __using__(opts) do
    quote do
      ...
      def load(%{} = data) do
        {:ok, struct(__MODULE__, Map.new load_fields!(data, @maptypes, Elixango.Ecto.Adapter))}
      ...
      def dump(struct) do
        {:ok, Map.new dump_fields!(struct, @maptypes, Elixango.Ecto.Adapter)}
      end
      def dump(), do: :error
    end
  end
...
defmodule Elixango.Ecto.Type do
  @moduledoc """
