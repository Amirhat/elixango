defmodule Elixango.Ecto.Repo.Schema do
  ...
  def load(adapter, schema_or_types, data) do
    do_load(schema_or_types, data, &Elixango.Ecto.Type.adapter_load(adapter, &1, &2))
  end
  ...
  defp autogenerate_id({key, source, type}, changes, return_types, return_sources, adapter) do
    cond do
      Map.has_key?(changes, key) -> # Set by user
        {changes, [], return_types, return_sources}
      value = Elixango.Ecto.Type.adapter_autogenerate(adapter, type) -> # Autogenerated now
